...
from MyraRobot import OWNER_USERNAME, SUPPORT_CHAT, dispatcher
...
PHOTO = [
    ...
    "https://telegra.ph/file/06df9b4cc15a1ed7b0eec.jpg",
]
...
async def awake(event):
    ...
    TEXT += f"» **ᴍʏ ᴅᴇᴠᴇʟᴏᴘᴇʀ​ : [𝗦𝗧𝝙𝗥𝗪𝗢𝗥𝗟𝗗](https://t.me/{OWNER_USERNAME})** \n\n"
